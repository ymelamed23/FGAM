...
player = player %>% 
  mutate(midrange_ex = ShotLocations.Mid_Range_FGA*(player_avgs$midrange_makes-ShotLocations.Mid_Range_FGM)/(player_avgs$midrange_shots-ShotLocations.Mid_Range_FGA),
         ...
         restricted_ex = ShotLocations.Restricted_Area_FGA*(player_avgs$restricted_makes-ShotLocations.Restricted_Area_FGM)/(player_avgs$restricted_shots-ShotLocations.Restricted_Area_FGM),
